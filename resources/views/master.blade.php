...
<div id="actionSheet_wrap">
    ...
    <div class="weui_actionsheet" id="weui_actionsheet">
        <div class="weui_actionsheet_menu">
            <div class="weui_actionsheet_cell" onclick="onMenuItem(1)">用户中心</div>
            <div class="weui_actionsheet_cell" onclick="onMenuItem(2)">选择套餐</div>
            <div class="weui_actionsheet_cell" onclick="onMenuItem(3)">周边油站</div>
            <div class="weui_actionsheet_cell" onclick="onMenuItem(4)">常见问题</div>
        </div>
